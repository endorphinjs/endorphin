import { elemWithText, createInjector, elem, text, get, insert, mountBlock, updateBlock, unmountBlock, mountIterator, updateIterator, unmountIterator } from "endorphin";
