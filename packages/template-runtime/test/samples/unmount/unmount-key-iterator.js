import { elemWithText, insert, elem, createComponent, setAttribute, mountComponent, updateComponent, unmountComponent, addDisposeCallback, markSlotUpdate, mountKeyIterator, updateKeyIterator, unmountKeyIterator, createInjector } from "../../../src/runtime";
import * as UnmountBeacon from "./unmount-beacon.js";

export default function $$template0(host, scope) {
	const target0 = host.componentView;
	const injector0 = createInjector(target0);
	insert(injector0, elemWithText("p", "Unmount key iterator"));
...
function $$iteratorKey0(host, scope) {
	return scope.value;
}
